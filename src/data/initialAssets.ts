...
export const INITIAL_ASSETS: Asset[] = [
  ...
  },
  {
    ...
    site_id: "",
    site_name: "Unassigned – Yard Depot",
    checkout_date: "2025-04-10",
    checkin_date: "2025-04-30",
    engine_hours_day: 0,
    idle_hours_day: 11,
    operating_days: 20,
    operator_id: null,
  ...
  },
  {
    ...
    operator_id: null,
    operator_name: null,
    // The unit has not been checked back in despite its expected return date;
    // it is therefore still an active rental, but unassigned and idle.
    status: "Active",
