...
export type Tab = 'map' | 'fleetmap' | 'analytics' | 'checkinout' | 'ai-forecasting' | 'inspection' | 'anomalies' | 'history';
interface HeaderProps { activeTab: Tab; setActiveTab: (tab: Tab) => void; assets: Asset[]; alerts: AnomalyAlert[]; onOpenCheckInOut: (type: 'checkout' | 'checkin') => void; onOpenInspection: () => void; onRefresh: () => void; onOpenCopilot: () => void; }
...
export const Header: React.FC<HeaderProps> = ({ activeTab, setActiveTab, assets, alerts, onOpenCheckInOut, onOpenInspection, onRefresh, onOpenCopilot }) => {
